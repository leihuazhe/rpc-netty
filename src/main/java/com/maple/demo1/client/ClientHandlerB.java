 ...
 */
public class ClientHandlerB extends ChannelInboundHandlerAdapter {

    @Override
    public void channelActive(ChannelHandlerContext ctx) {
        System.out.println(" ClientHandlerB ...  Active");
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) {
        ...
        System.out.println("ClientHandlerB read Message:   " + msg);
    ...
    public void handlerAdded(ChannelHandlerContext ctx) throws Exception {
        System.out.println("ClientHandlerB 已经被添加到了 ch");
    }

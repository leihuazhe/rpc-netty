...
public class RpcMsgDecoder extends ByteToMessageDecoder {
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf msg, List<Object> out) throws Exception {
        LOGGER.info("RpcMsgDecoder Dump byteBuf: {}", DumpUtil.dumpToStr(msg));
        try {
...
//            String result = msg.toString(msg.readerIndex(), msg.readableBytes() - 1, Charset.forName("UTF-8"));
           ...
           /* ByteBuf resultBuf = null;
            ...
            byte[] dst = new byte[msg.readableBytes() - 1];
            msg.readBytes(dst);

            msg.readByte();

            out.add(gson.fromJson(new String(dst), RpcObject.class));
